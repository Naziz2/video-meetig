...
import { ArrowRight, Shield, Users, Globe, Zap, Clock, Laptop, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-secondary-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Meeting Scheduler Section (only for logged in users) */}
        {user && (
          <div className="mt-20 mb-20">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-secondary-600 dark:text-secondary-300">
                Schedule, join, and manage all your video conferences in one place
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5">
                {showScheduler ? (
                  <MeetingScheduler 
                    compact={true} 
                    onScheduleComplete={() => setShowScheduler(false)}
                  />
                ) : (
                  <div className="bg-theme-card rounded-2xl p-6 border border-theme h-full flex flex-col justify-center items-center">
                    <Calendar className="w-16 h-16 text-theme-button mb-4" />
                    <h3 className="text-xl font-semibold text-white mb-2">Schedule a New Meeting</h3>
                    <p className="text-gray-400 text-center mb-6 max-w-md">
                      Create a new video conference with your team in just a few clicks
                    </p>
                    <button
                      onClick={() => setShowScheduler(true)}
                      className="bg-theme-button hover:bg-theme-button-hover text-white px-6 py-2.5 rounded-xl font-medium transition-all duration-300"
                    >
                      Schedule Now
                    </button>
                  </div>
