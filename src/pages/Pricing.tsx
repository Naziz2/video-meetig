      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan) => (
            ...
            >
              {plan.highlight && (
                <div className="bg-wolt-teal text-white text-center py-1 text-xs font-medium">
                  MOST POPULAR
                </div>
              )}
              ...
              <div className="p-6">
                ...
                <p className="text-secondary-600 dark:text-secondary-400 mt-1">{plan.description}</p>
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-lg font-medium transition-colors ${
                    plan.highlight
                      ? 'bg-wolt-blue hover:bg-blue-600 text-white'
                ...
                <div className="mt-6">
                  <p className="text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-3">What's included:</p>
                  ...
                  {plan.notIncluded.length > 0 && (
                    <>
                      <p className="text-sm font-medium text-secondary-500 dark:text-secondary-400 mt-4 mb-3">Not included:</p>
                      <ul className="space-y-2">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white dark:bg-secondary-800 rounded-xl p-6 border border-gray-100 dark:border-secondary-700">
              ...
              <p className="text-secondary-600 dark:text-secondary-300">
                We accept all major credit cards, including Visa, Mastercard, and American Express. We also support PayPal for both monthly and annual subscriptions.
              </p>
            </div>
